...
if inference:
    ...
    print("Epoch %d got best ndcg@30_down on dev set: %.4f" % (best_dev_epoch + 1, score_list_dev['ndcg_k_down'][best_dev_epoch]))
    print("Epoch %d got ndcg@30_down on test set w.r.t dev set: %.4f" % (best_dev_epoch + 1, score_list_test['ndcg_k_down']
    [best_dev_epoch]))
    best_test_epoch = np.argmax(score_list_test['ndcg_k_down'])
    print("Epoch %d got ndcg@30 on test set: %.4f" % (best_test_epoch + 1, score_list_test['ndcg_k_down'][best_test_epoch]))
